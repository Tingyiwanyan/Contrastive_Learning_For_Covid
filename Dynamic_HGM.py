...
class dynamic_hgm():
    ...
    def __init__(self,kg,data_process):
        ...
        self.weight_att_W = tf.Variable(self.init_weight_att_W(shape=(self.latent_dim,self.latent_dim_att)))
        self.weight_vec_a = tf.Variable(self.init_weight_vec_a(shape=(2*self.latent_dim_att,)))
