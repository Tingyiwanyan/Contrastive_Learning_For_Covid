...
class LSTM_model():
    ...
    def __init__(self,kg,data_process):
        ...
        self.weight_classification_w = tf.Variable(self.init_weight_classification_w(shape=(self.latent_dim,1)))#+self.latent_dim_demo,1)))
    ...
    def softmax_loss(self):
        ...
        self.output_layer = tf.math.sigmoid(tf.math.add(tf.matmul(self.hidden_last,self.weight_classification_w),self.bias_classification_b))
